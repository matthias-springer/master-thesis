...
\begin{wrapfigure}{l}{0.5\textwidth}
	\includegraphics[scale=0.7]{st_nested.pdf}
	\centering
	\caption[Example: Top-level class \texttt{Smalltalk}]{Example: Top-level class \texttt{Smalltalk}. All classes should be nested within \texttt{Smalltalk}.}

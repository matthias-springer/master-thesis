...
<@\textbf{MyLibrary class>>BaseClass}@>
    <@\textcolor{OliveGreen}{\textbf{< class >}}@>
    <@\textcolor{gray}{" This is the class that serves as }@>
      <@\textcolor{gray}{an input for the mixin in this example. "}@>
	

<@\textbf{MyLibrary class>>CollectionMixin:}@> base
    <@\textcolor{OliveGreen}{\textbf{< class >}}@>
    <@\textcolor{gray}{" This class is uncached because it is parameterized "}@>
...
<@\textbf{MyLibrary class>>MyCollection}@>
    <@\textcolor{OliveGreen}{\textbf{< class >}}@>
    <@\textcolor{gray}{" This is the cached mixin application. "}@>

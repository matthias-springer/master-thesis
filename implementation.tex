...
Figure~\ref{fig:lazy_class_gen} illustrates how the system generates and initializes a nested class (class specification instantiation). \todo{Add methods for class parameters.}
...
\todo{Cache must map self to instantiation}

...
\begin{figure}[!htp]
\begin{lstlisting}
<@\textbf{MyApplication class>>CachedCollection}@>
    <@\textcolor{OliveGreen}{\textbf{< class >}}@>
    ^ Repository CachedCollection

<@\textbf{MyApplication class>>CachedCollection>>asString}@>
